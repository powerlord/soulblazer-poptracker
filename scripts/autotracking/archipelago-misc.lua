function updateArchipelagoMiscRewardsFromMemorySegment( segment )
  ...
  updateToggleItemFromBit( segment, "soullightitem", 0x7e1b1a, 0x20 ) -- 0x3D
  updateToggleItemFromBit( segment, "soulshielditem", 0x7e1b1a, 0x40 ) -- 0x3E
  updateToggleItemFromBit( segment, "souldetectionitem", 0x7e1b1a, 0x80 ) -- 0x3F
  updateToggleItemFromBit( segment, "soulrealityitem", 0x7e1b1b, 0x01 ) -- 0x40
